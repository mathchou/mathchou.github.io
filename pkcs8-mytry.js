(() => {
  ...
  */
  async function exportCryptoKey(key, pubkey) {
	...
	const exportedAsStringPub = ab2str(exportedpub);
    const exportedAsBase64Pub = window.btoa(exportedAsStringPub);
  ...
  */
  window.crypto.subtle.generateKey(
    ...
    exportButton.addEventListener("click", () => {
      exportCryptoKey(keyPair.privateKey, keyPair.publicKey);
    });
